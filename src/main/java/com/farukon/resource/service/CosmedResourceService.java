...
import com.farukon.common.util.RawHttpRequest;
 ...
 */
public class CosmedResourceService implements ResourceService {
    ...
    public List<String> parseCatalogPage(String url) {
        ...
        String pageContent = RawHttpRequest.doHttpGet(url);
        ...
        navLinks.forEach((String s) -> {
            String itemPageContent = RawHttpRequest.doHttpGet(s);
